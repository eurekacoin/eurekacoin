...
from test_framework.eurekacoin import activate_mpos
from test_framework.eurekacoinconfig import COINBASE_MATURITY
import time

class EurekaCoinCallContractTimestampTest(BitcoinTestFramework):
...
if __name__ == '__main__':
    EurekaCoinCallContractTimestampTest().main()
