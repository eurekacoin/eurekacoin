#ifndef EUREKACOINVERSIONCHECKER_H
#define EUREKACOINVERSIONCHECKER_H

#include <QObject>

#define EUREKACOIN_RELEASES "https://github.com/eurekacoin/eurekacoin/releases"
...
class EurekaCoinVersionChecker : public QObject
{
    Q_OBJECT
public:
    explicit EurekaCoinVersionChecker(QObject *parent = 0);
    ~EurekaCoinVersionChecker();
...
#endif // EUREKACOINVERSIONCHECKER_H
