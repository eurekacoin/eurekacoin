...
class EurekaCoinStyle : public QProxyStyle
{
public:
...
void StyleSheet::setStyleSheet(QApplication *app, const QString& style_name)
{
    ...
    EurekaCoinStyle* eurekacoinStyle = new EurekaCoinStyle;
    eurekacoinStyle->setBaseStyle(mainStyle);
    app->setStyle(eurekacoinStyle);
