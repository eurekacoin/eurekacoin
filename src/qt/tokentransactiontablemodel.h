#ifndef EUREKACOIN_QT_TOKENTOKENTRANSACTIONTABLEMODEL_H
#define EUREKACOIN_QT_TOKENTOKENTRANSACTIONTABLEMODEL_H
...
#endif // EUREKACOIN_QT_TOKENTOKENTRANSACTIONTABLEMODEL_H
