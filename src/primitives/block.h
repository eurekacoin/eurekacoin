...
public:
    ...
    void SetNull()
    {
        ...
        nBits = 0;
        nNonce = 0;
        hashStateRoot.SetNull(); // eurekacoin
        hashUTXORoot.SetNull(); // eurekacoin
        vchBlockSig.clear();
    ...
    virtual bool IsProofOfStake() const //eurekacoin
    {
    ...
    CBlockHeader& operator=(const CBlockHeader& other) //eurekacoin
    {
        if (this != &other)
        {
...
public:
    ...
    std::pair<COutPoint, unsigned int> GetProofOfStake() const //eurekacoin
    {
