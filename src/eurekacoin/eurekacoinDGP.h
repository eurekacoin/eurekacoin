#ifndef EUREKACOINDGP_H
#define EUREKACOINDGP_H
...
public:
    ...
    EurekaCoinDGP(EurekaCoinState* _state, bool _dgpevm = true) : dgpevm(_dgpevm), state(_state) { initDataEIP158(); }
